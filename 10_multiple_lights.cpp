...
int main() {
  ...
  std::string lighting_vertex_shader = shader_path + "/6.multiple_lights.vs";
  std::string lighting_fragment_shader = shader_path + "/6.multiple_lights.fs";
  std::string lamp_vertex_shader = shader_path + "/6.lamp.vs";
  std::string lamp_fragment_shader = shader_path + "/6.lamp.fs";
  ...
  // organized)
  // -----------------------------------------------------------------------------
  std::string img1_path = shader_path + "/container2.png";
  std::string img2_path = shader_path + "/container2_specular.png";
