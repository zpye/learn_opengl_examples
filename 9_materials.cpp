...
int main() {
  ...
  std::string lighting_vertex_shader = shader_path + "/3.1.materials.vs";
  std::string lighting_fragment_shader = shader_path + "/3.1.materials.fs";
  std::string lamp_vertex_shader = shader_path + "/3.1.lamp.vs";
  std::string lamp_fragment_shader = shader_path + "/3.1.lamp.fs";
